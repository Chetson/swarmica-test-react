...
import {Dropdown, DropdownItem, InputWrapper, SearchContainer, Spinner, StyledInput} from "./styles.ts";
...
export const SearchInput: React.FC<SearchInputProps> = ({
    ...
    const fetchResults = useCallback(async (searchQuery: string) => {
        ...
        try {
            ...
            const filtered = data.filter((article: SearchResult) => article.title[currentLocale])
